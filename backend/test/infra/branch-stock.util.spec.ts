...
assert.equal(formatBranchStockLocationName('مخزون فرع مدينة نصر'), 'رصيد فرع مدينة نصر');
assert.equal(formatBranchStockLocationName(''), 'رصيد الفرع');

console.log('branch-stock.util.spec: ok');

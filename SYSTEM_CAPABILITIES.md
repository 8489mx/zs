...
* **المعايير والخصائص الهندسية المنفذة:**
  ...
  2. **حصر اختيار النمط في التهيئة الأولى وقفل الإعدادات (First-Run Lockdown):**
     - يختار العميل نمط ونشاط منشأته مرة واحدة فقط عند التهيئة الأولى للنظام (سواء ساس أو إلكترون).
     - بمجرد اكتمال الإعداد، يختفي اختيار النمط نهائياً من إعدادات النظام العامة منعاً لأي تلاعب أو عبث ببيانات الحسابات والمخازن في بيئة التشغيل الحية، ويكتفي النظام بعرض وسم مؤسسي توضيحي غير قابل للتعديل.

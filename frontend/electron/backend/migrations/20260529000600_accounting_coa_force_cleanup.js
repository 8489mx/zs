...
const LEGACY_CODES = ['1300', '1400', '2200', '5400'];
async function forceUpdateSeedAccount(db, account) {
    let parentId = null;
    if (account.parentCode) {
        const parentResult = await (0, kysely_1.sql) `
      SELECT id
...
async function cleanupLegacyAccount(db, code) {
    await (0, kysely_1.sql) `
...
async function forceAccountingSettings(db) {
    await (0, kysely_1.sql) `
...
//# sourceMappingURL=20260529000600_accounting_coa_force_cleanup.js.map
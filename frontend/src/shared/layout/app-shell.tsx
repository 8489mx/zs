...
export function AppShell({ children }: PropsWithChildren) {
  ...
  const visibleNavigationItems = useMemo(() => {
    ...
    const labelOverrides: Record<string, string> = {
      ...
      maintenance: t('sidebar.maintenance', 'تذاكر الصيانة'),
      'trade-in': t('sidebar.trade-in', 'شراء واستبدال الأجهزة'),
      'imei-history': t('sidebar.imei-history', 'سجل وتتبع IMEI'),
      ...
      'accounting-journal-entries': t('sidebar.accounting-journal-entries'),
      'accounting-settings': t('sidebar.accounting-settings'),
      'pricing-center': t('sidebar.pricing-center'),
      hr: t('sidebar.hr'),
      audit: t('sidebar.audit'),
      'saas-admin-tenants': t('sidebar.saas-admin-tenants'),
      settings: t('sidebar.settings'),
      'manufacturing-boms': t('sidebar.manufacturing-boms'),
  ...
  const sidebarGroups = useMemo<SidebarGroupDefinition[]>(() => ([
    { key: 'sales-group', label: t('sidebar.sales-group'), itemKeys: ['sales', 'tax-dispatcher', 'returns', 'delivery-reps', 'customers'] },
    { key: 'purchases-group', label: t('sidebar.purchases-group'), itemKeys: ['purchases-new', 'purchases', 'purchase-returns', 'suppliers'] },
    { key: 'reports-group', label: t('sidebar.reports-group', 'التقارير والتحليلات'), itemKeys: ['reports-overview', 'reports-sales', 'reports-treasury', 'reports-inventory', 'reports-purchases', 'reports-balances', 'reports-employees'] },

...
export const appRoutes: AppRouteDefinition[] = [
  ...
  { path: 'returns', label: 'مرتجعات المبيعات', element: <DashboardPage />, navigation: true },
  { path: 'pos', label: 'نقطة البيع', element: <PosPage />, navigation: true },
  { path: 'purchases', label: 'فواتير المشتريات', element: <PurchasesPage />, navigation: true },
  { path: 'purchase-returns', label: 'مرتجعات المشتريات', element: <DashboardPage />, navigation: true },

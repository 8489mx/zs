import type { IndustryPresetId } from '@/features/settings/components/modular-configurator/modular-presets';

export function PresetIcon({ id, size = 22 }: { id: IndustryPresetId; size?: number }) {
  if (id === 'retail') {
    return (

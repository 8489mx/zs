...
export function BranchReferenceCard(props: {
  ...
  const { branches, branchList, filteredCount, branchSearch, branchFilter, setBranchSearch, setBranchFilter, resetBranchFilters, copyVisibleBranches, branchesQuery, canManageSettings, editingBranch, setEditingBranch, setDeleteConfirm, branchActionBusy, branchActionError, onUpdateBranch, onShowAddBranch } = props;
  return (

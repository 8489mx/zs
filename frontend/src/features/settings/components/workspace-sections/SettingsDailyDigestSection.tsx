        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="bg-[#170e5e] hover:bg-[#120b4c] text-white font-bold text-xs px-6 h-9"
            >
              {saveMutation.isPending ? 'جاري الحفظ...' : saveSuccess ? 'تم الحفظ بنجاح ✓' : 'حفظ الإعدادات'}
            </Button>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-5">
            <h3 className="font-bold text-slate-800 text-sm border-b border-slate-100 pb-3 flex items-center gap-2">
              <span>⚙️ خيارات الجدولة والإرسال</span>
            </h3>
            ...
            <div className="pt-2 border-t border-slate-100">
              ...
              <div className="space-y-2.5">
                ...
                <label className="flex items-start gap-3 p-3 rounded-xl border border-slate-200 hover:bg-slate-50/50 cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="text-xs font-bold text-slate-800 block">⚠️ بلوك نواقص المستودع الحرج</span>
                    <span className="text-[11px] text-slate-500">
            ...
            <div className="bg-white rounded-xl rounded-tr-none p-3.5 shadow-xs border border-slate-200 text-slate-800 text-xs leading-relaxed space-y-2.5">
              ...
              {config.includeTransfers && (
                <div className="space-y-1 pt-1.5 border-t border-slate-100">
                  ...
                  <div className="text-[11px] text-slate-600 space-y-0.5 pr-2">
                    <div className="font-semibold text-indigo-900">📋 إذن رقم #TR-882 ➔ صالة المحل:</div>
              ...
              {config.includeShortages && (
                <div className="space-y-1 pt-1.5 border-t border-slate-100">
                  <div className="font-bold text-slate-900">⚠️ نواقص المستودع التي تحتاج شراء:</div>
                  <div className="text-[11px] text-slate-600 space-y-0.5 pr-2">
              ...
              <div className="pt-2 border-t border-slate-100 text-[10px] text-slate-400 flex items-center justify-between">
                ...
                <span className="text-emerald-700">✓✓ مقروءة</span>
              </div>
            </div>
          </div>
        </div>

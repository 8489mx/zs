...
> = {
  ...
  maritimeFreightModuleEnabled: { tab: 'modules', label: 'موديول الشحن البحري واللوجستيات' },
  contractingModuleEnabled: { tab: 'modules', label: 'موديول المقاولات والمشاريع الإنشائية' },

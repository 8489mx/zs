...
export const INDUSTRY_PRESETS: Record<IndustryPresetId, IndustryPreset> = {
  ...
  services: {
    id: 'services',
    name: 'الشركات الخدمية والمقاولات والاستشارات',
    subtitle: 'مكاتب خدمات، شركات مقاولات، واستشارات',
    description: 'إصدار فواتير الخدمات والمصنعيات بدون تعقيدات مخزون بضائع، مع إدارة المشاريع والحسابات.',
    ...
    defaultPosMode: 'scanner',
    defaultProductKind: 'standard',
    highlights: ['فواتير الخدمات والمصنعيات وعقود المشاريع', 'مشتريات مستلزمات التشغيل والخدمات', 'الحسابات العامة وشجرة الحسابات والتقسيط'],
  },

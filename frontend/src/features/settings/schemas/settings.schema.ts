...
export const settingsFormSchema = z.object({
  ...
  hrModuleEnabled: z.boolean().default(true),
  ...
  storefrontModuleEnabled: z.boolean().default(true),
  installmentsModuleEnabled: z.boolean().default(true),
  fixedAssetsModuleEnabled: z.boolean().default(true),
  taxDeclarationModuleEnabled: z.boolean().default(true),
  deliveryFleetModuleEnabled: z.boolean().default(true),

...
export const settingsFormSchema = z.object({
  ...
  expiryAlertDays: z.coerce.number().int().min(1, 'المدة يجب أن تكون يوم واحد على الأقل').default(30),
  stagnantProductDays: z.coerce.number().int().min(1, 'المدة يجب أن تكون يوم واحد على الأقل').default(30),

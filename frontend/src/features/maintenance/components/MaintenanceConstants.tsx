import type { MaintenanceStatus } from '@/types/domain-models/maintenance';
...
export const MaintenanceIcons = {
  ...
  Printer: () => (
    <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M6 18H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2" />
...
export const statusConfig: Record<MaintenanceStatus, { label: string; bg: string; border: string; color: string; dot: string }> = {
  received: {
    label: 'استلام جديد',
    bg: '#f0f9ff',
    border: '#bae6fd',

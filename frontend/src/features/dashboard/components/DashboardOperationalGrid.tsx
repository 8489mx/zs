...
export function DashboardOperationalGrid({
  ...
  return (
    <section className="dashboard-content-grid dashboard-content-grid-wide">
      <FormSection title="مؤشرات الإدارة" className="dashboard-premium-card dashboard-card-compact">
      ...
      <FormSection title="ملخص السيولة" className="dashboard-premium-card dashboard-card-compact">
        <div className="metric-list">

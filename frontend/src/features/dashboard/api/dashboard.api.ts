...
import type { DashboardManagerOverviewPayload, DashboardOverviewPayload, ManagerActionsPayload } from '@/features/dashboard/api/dashboard.types';
...
export const dashboardApi = {
  ...
  managerOverview: () => http<DashboardManagerOverviewPayload>('/api/dashboard/manager-overview'),
  managerActions: (limit = 8) => http<ManagerActionsPayload>(`/api/manager-actions?limit=${encodeURIComponent(String(limit))}`)
};

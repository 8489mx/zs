...
- Name: routes.spec.ts >> route smoke coverage >> loads /products
- Location: tests/e2e/routes.spec.ts:25:5

# Error details

```
Error: page.goto: net::ERR_BLOCKED_BY_ADMINISTRATOR at http://127.0.0.1:4173/products
Call log:
  - navigating to "http://127.0.0.1:4173/products", waiting until "load"

...
- Name: routes.spec.ts >> route smoke coverage >> loads /cash-drawer
- Location: tests/e2e/routes.spec.ts:25:5

# Error details

```
Error: page.goto: net::ERR_BLOCKED_BY_ADMINISTRATOR at http://127.0.0.1:4173/cash-drawer
Call log:
  - navigating to "http://127.0.0.1:4173/cash-drawer", waiting until "load"
